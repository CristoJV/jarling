...
describe('CategoryTarget', () => {
  it.each([
    {
      ...
      weeklyFundingMode: 'set_aside' as const,
    },
    { ...base, kind: 'monthly' as const, dayOfMonth: 0 },
    { ...base, kind: 'yearly' as const, targetDate: '2026-12-31' },
    {
      ...base,
  ...
  it.each([
    { ...base, kind: 'weekly' as const, dayOfWeek: 6 as const },
    {
      ...
      kind: 'weekly' as const,
      dayOfWeek: 6 as const,
      weeklyFundingMode: 'refill_up_to' as const,
      targetDate: '2026-12-31',
    },
    { ...base, kind: 'monthly' as const, dayOfMonth: 32 },
    { ...base, kind: 'monthly' as const },
    { ...base, kind: 'yearly' as const, targetDate: '2026-02-30' },

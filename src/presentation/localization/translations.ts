export const english = {
  ...
  'settings.backupProgress.preparing': 'Preparing your backup…',
  'settings.backupProgress.snapshot': 'Creating a portable snapshot…',
  'settings.backupProgress.encrypting': 'Encrypting your plan…',
  'settings.backupProgress.saving': 'Preparing the file to save…',
...
export const spanish: TranslationDictionary = {
  ...
  'settings.backupProgress.preparing': 'Preparando la copia…',
  'settings.backupProgress.snapshot': 'Creando una instantánea portable…',
  'settings.backupProgress.encrypting': 'Cifrando tu presupuesto…',
  'settings.backupProgress.saving': 'Preparando el archivo para guardarlo…',
